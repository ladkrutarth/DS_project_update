...
├── run.sh                              # 🚀 Unified Setup & Runner Script
│
...
The fastest way to get Veriscan running is via the unified `run.sh` script, which handles environment setup, dependencies, and data initialization.

### 1. Requirements
- macOS with Apple Silicon (M1/M2/M3)
- Python 3.9+

### 2. Automatic Setup & Run
Run the following command to set up the virtual environment, install dependencies, initialize data, and launch all services:
```bash
# This script handles everything (Venv, Pip, Run)
bash run.sh
```

### 3. Setup Only (Optional)
If you only want to prepare the environment without launching the services:
```bash
bash run.sh --setup-only
```

### 4. Manual Launch (After Setup)
If you prefer starting services in separate terminals:
```bash
...
For more detailed guides and support, refer to the following resources:

- **[Demo Guide](file:///Users/kukulad/.gemini/antigravity/brain/16214313-5aeb-48ce-817c-54643174726c/demo_guide.md)**: A step-by-step walkthrough for your presentation.
- **[Troubleshooting Guide](file:///Users/kukulad/.gemini/antigravity/brain/16214313-5aeb-48ce-817c-54643174726c/troubleshooting.md)**: Solutions for common setup and runtime issues.
- **[Data Inventory](file:///Users/kukulad/.gemini/antigravity/brain/16214313-5aeb-48ce-817c-54643174726c/data_inventory.md)**: Detailed breakdown of the datasets used in this project.
